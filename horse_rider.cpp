...
const int HORSE_HEALTH_DROP_INTERVAL = 7 * 24 * 60 * 60;	//马健康下降间隔
const int HORSE_STAMINA_CONSUME_INTERVAL = 60 * 60;		//马耐力消耗间隔
const int HORSE_STAMINA_REGEN_INTERVAL = 50 * 60;		//马耐力恢复间隔

// const int HORSE_HEALTH_DROP_INTERVAL = 7 * 24 * 60 * 60;	//马健康下降间隔
// const int HORSE_STAMINA_CONSUME_INTERVAL = 24 * 60 * 60;	//马耐力消耗间隔
// const int HORSE_STAMINA_REGEN_INTERVAL = 60 * 60;			//马耐力恢复间隔
