...
namespace quest
{
	...
	ALUA (party_get_all_member_pids)
	{
		CQuestManager &q = CQuestManager::instance();
		LPCHARACTER ch = q.GetCurrentCharacterPtr();
		LPPARTY pParty = ch->GetParty();
	...
	ALUA (party_get_total_member)
	{
		...
		lua_pushnumber (L, pParty->GetMemberCount());
		return 1;
	}
#endif
...
#endif
#ifdef __VERSION_162__
			{ "get_all_member_pids",	party_get_all_member_pids	},
			{ "get_total_member",		party_get_total_member	},
#endif
