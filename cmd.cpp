...
struct command_info cmd_info[] =
{
	...
	{ "dc2",		do_client_gb,		0,			POS_DEAD,	GM_IMPLEMENTOR	},
	...
	{ "ipurge",		do_item_purge,		0,			POS_DEAD,	GM_HIGH_WIZARD	},//헌잿교관
...
#endif
#ifdef ENABLE_SELECT_ATTRIBUTES
	{ "set_attributes",		do_set_attributes,		0,	POS_DEAD,	GM_PLAYER	},
	{ "send_attributes",	do_send_attributes,		0,	POS_DEAD,	GM_PLAYER	},
#endif
#ifdef ENABLE_BOT_PLAYER
...
#endif
#ifdef _PLAYER_CHEAT_SUPPORT_
	{ "binary_stuff",	do_binary_stuff,	0,		POS_DEAD,		GM_PLAYER	},
#endif
#ifdef ENABLE_GOLDTIGER_BETTING
	{ "quiz_start",		do_quiz_start,	0,		POS_DEAD,		GM_HIGH_WIZARD	},
	{ "quiz_stop",		do_quiz_stop,	0,		POS_DEAD,		GM_HIGH_WIZARD	},
#endif
#ifdef ENABLE_BIOLOG_QUEST_SYSTEM
...
#endif
#ifdef TOURNAMENT_PVP_SYSTEM
	{ "warp_tpvp",	do_warp_tournament_map, 0,			POS_DEAD,	GM_IMPLEMENTOR	},
#endif
