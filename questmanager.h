...
namespace quest
{
	...
	public:
		...
		void		RequestSetEventFlag(const string& name, int64_t value);

		void		SetEventFlag(const string& name, int64_t value);
		int64_t			GetEventFlag(const string& name);
	...
	private:
		...
		map<string, int64_t>		m_mapEventFlag;
