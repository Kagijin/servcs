...
// QUICKSLOT HANDLING
/////////////////////////////////////////////////////////////////////////////
void CHARACTER::SyncQuickslot(BYTE bType, QS_USHORT bOldPos, QS_USHORT bNewPos)
{
	if (bOldPos == bNewPos)
		return;
...
bool CHARACTER::GetQuickslot(QS_USHORT pos, TQuickslot** ppSlot)
{
...
bool CHARACTER::SetQuickslot(QS_USHORT pos, TQuickslot& rSlot)
{
...
bool CHARACTER::DelQuickslot(QS_USHORT pos)
{
...
bool CHARACTER::SwapQuickslot(QS_USHORT a, QS_USHORT b)
{
...
void CHARACTER::ChainQuickslotItem(LPITEM pItem, BYTE bType, QS_USHORT bOldPos)
{
